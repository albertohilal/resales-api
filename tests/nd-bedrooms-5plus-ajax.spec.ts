...
test('Filtro de dormitorios “5+” solo New Developments — actualiza tarjetas por AJAX', async ({ page }) => {
  ...
  // 9. Verificar que ninguna tarjeta muestre “1 dormitorio”, “2 dormitorio”, “3 dormitorio” o “4 dormitorio”
  for (let i = 0; i < cardCount; i++) {
    const text = await cards.nth(i).innerText();
    expect(text).not.toMatch(/\b[1-4]\s+dormitorio\b/);
  }
});
